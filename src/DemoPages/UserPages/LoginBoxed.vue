                    ...
                    <div class="modal-dialog w-100 mx-auto">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <h6 class="mb-0">
                                    No account?
                                    <router-link class="text-primary" to="/pages/register-boxed">Sign up now</router-link>
                            ...
                            <div class="modal-footer clearfix">
                                ...
                                <div class="float-right">
                                    <router-link class="btn btn-primary btn-lg" to="/">Login to Dashboard</router-link>
